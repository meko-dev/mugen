...
var Component = class extends HTMLElement {
  ...
  render() {
    ...
    render(__privateGet(this, _shadowRoot), html`
...
__publicField(Component, "formAssociated", true);
export {
